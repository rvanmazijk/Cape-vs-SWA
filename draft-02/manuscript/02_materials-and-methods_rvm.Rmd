...
We developed an index of EH that would account for the spatial configuration of different environmental conditions. Our index, as applied to raster data, employs a moving-window function of nine pixels, representing eight neighbour pixels about a focal pixel ($x^*$). Our index represents the average magnitude of the difference between pixels' conditions and that of their neighbours, as follows:
