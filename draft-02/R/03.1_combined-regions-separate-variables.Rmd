...
```{r plot-combined-region-PC1-models, fig.width=6, fig.height=3.5, fig.cap="The fits of the common regressions of (a) $S_{\\mathrm{HDS}}$ and (b) $S_{\\mathrm{QDS}}$ against each respective scale's PC1 scores (Table 4 and 5). Grey bands denote 95% confidence intervals."}
