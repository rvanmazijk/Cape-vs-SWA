...
for (pred in unique(HDS_richness_models_summary_printable$predictor)) {
  HDS_richness_models_summary_printable$predictor[
    HDS_richness_models_summary_printable$predictor == pred
  ][-1] <- " "
}
...
knitr::kable(model_comparion,
  caption = paste(
    ...
    "regressions of $S_{\\mathrm{QDS}}$ against environmental heterogeneity",
    "variables."
  ),
...
add_turnover_prop_models_no_region %>%
  ...
  knitr::kable(
    caption = paste(
      "Results of separate simple linear regressions of $T_{\\mathrm{QDS}} /",        "S_{\\mathrm{HDS}}$ against environmental heterogeneity variables",
      "with no region-term."
    ),
    col.names = c(
      "Predictor",   "$R^2$",
...
knitr::kable(model_comparion,
  caption = paste(
    "Comparisons of best-fitting models across separate simple linear",
    "regressions of $T_{\\mathrm{QDS}} / S_{\\mathrm{HDS}}$ against",
