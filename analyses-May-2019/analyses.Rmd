...
The richness and turnover measures used are the same as in the previous section, while the environmental heterogeneity was recalculated in grid
...
my_AIC_table <- function(..., caption = "...") {
  AIC(...) %>%
    ...
    knitr::kable(
      caption = caption,
      col.names = c("Model", "$AIC$", "$\\Delta AIC$", "$w_{Akaike}$"),
      align = c("lrrr")
    )
}
```
