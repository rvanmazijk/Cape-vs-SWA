...
```{r, out.width=100}
knitr::include_graphics("logos/UCT-logo.png")
```
```{r, out.width=100}
knitr::include_graphics("logos/BIO-logo.png")
```
```{r, out.width=150}
knitr::include_graphics("logos/eResearch-logo.png")
```
```{r, out.width=200}
knitr::include_graphics("logos/DST-logo.png")
```
```{r, out.width=150}
knitr::include_graphics("logos/NRF-logo.png")
```
```{r, out.width=150}
knitr::include_graphics("logos/SAAB-logo.png")
```
...
![](logos/BIO-logo.png){ width=80 }
![](logos/eResearch-logo.png){ width=100 }
![](logos/DST-logo.png){ width=180 }
![](logos/NRF-logo.png){ width=100 }
![](logos/SAAB-logo.png){ width=100 }
