...
#source(here::here("figures-and-tables/01_run-analyses.R"))  # Already ran
source(here::here("figures-and-tables/02_import-analyses-outputs.R"))
var_names <- c(
    "Elevation",
    "MAP",
    "PDQ",
...
```{r rq_turnover_vs_geodist, eval = TRUE, results = "asis"}
