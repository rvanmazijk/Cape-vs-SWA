# Make Fig. X (QDS-scale richness model quality)
...
summary_data <- read_csv(glue("{output_path}/QDS-richness-models-summaries.csv"))
...
ggsave(
  here("figures/fig-3.1-QDS-richness-quality-plots.png"),
  quality_plots,
  width = 6, height = 4,
  dpi = 300
)
