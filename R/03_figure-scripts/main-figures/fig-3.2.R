# Make Fig. X (HDS-scale richness model quality)
...
summary_data <- read_csv(glue("{output_path}/HDS-richness-models-summaries.csv"))
...
ggsave(
  here("figures/fig-3.2-HDS-richness-quality-plots.png"),
  quality_plots,
  width = 6, height = 4,
  dpi = 300
)
