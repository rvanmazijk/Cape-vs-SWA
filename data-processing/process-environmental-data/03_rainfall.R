...
organise_by_year_and_month <- function() {
...
average_by_month <- function() {

    jan_and_feb <- function() {

      jan_stack <- stack()
      for (i in seq_along(years)) {
        x <- chirps_monthly_GCFR[[
          chirps_by_year_by_month[[
