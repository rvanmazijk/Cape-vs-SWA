...
Distributions were constructed with Gaussian kernels, with bandwidth following Silverman's "rule of thumb" [@Silverman1986; $0.9 \times min \left ( \left \{ \sigma^{2}, \frac{IQR}{1.34 \times n^{-\frac{1}{5}}} \right \} \right )$].
