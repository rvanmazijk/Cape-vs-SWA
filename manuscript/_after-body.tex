...
\begin{figure}[H]
\includegraphics[width=41.67in]{/Users/ruanvanmazijk/projects/Cape-vs-SWA/figures/fig-1-roughness} \caption{(ref:roughness)}\label{fig:roughness}
\end{figure}

\begin{figure}[H]
\includegraphics[width=30in]{/Users/ruanvanmazijk/projects/Cape-vs-SWA/figures/fig-2-richness-vs-turnover} \caption{(ref:richness-vs-turnover)}\label{fig:richness-vs-turnover}
\end{figure}
