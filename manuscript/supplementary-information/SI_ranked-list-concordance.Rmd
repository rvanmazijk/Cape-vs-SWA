...
The $P$-value, then, is the probability that two lists have items in the observed orders, compared to two random lists. This can then quantify how similar two lists orderings are relevant to chance.
