...
We see that---across all variables considered---Cape grid-cells are more environmentally heterogeneous (i.e. more different from each of their neighbouring cells) in the majority pairwise comparisons of grid-cells ($CLES \gt 0.50$). The degree to which Cape grid-cells are more rough is dependent on both spatial scale and the environmental variable concerned.
