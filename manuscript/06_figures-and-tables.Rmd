...
if (all(!folder_is_empty(here::here("analyses/04_outputs"),
    ...
    import_all_objects_auto(here::here("analyses/04_outputs"))
    import_all_objects_auto(here::here("analyses/05_outputs"))
    import_all_objects_auto(here::here("analyses/06_outputs"))
    import_all_objects_auto(here::here("analyses/07_outputs"))
} else {
    # Otherwise run the analyses needed first, then import
...
```{r full_model_gamma_vs_alpha_beta, results="asis"}

turnover_richness_HDS_m_tidy <- broom::tidy(read_rds(here::here(
    "analyses/06_outputs/turnover_richness_HDS_m.RDS"
)))
...
```{r rq_turnover_vs_geodist, results = "asis"}
