...
```{r BRT-quality-perms, results="asis"}
options(knitr.kable.NA = "")
quality_rank_data %>%
...
```{r BRT-quality-regions, results="asis"}
options(knitr.kable.NA = "")
quality_region_data %>%
...
```{r species-environment-relationships, fig.pos="H", out.width="18cm", fig.cap="(ref:species-environment-relationships)"}
