...
knitr::include_graphics(here("figures/fig-1-roughness.png"))
```

```{r turnover, fig.pos="H", out.width="12cm", fig.cap="(ref:turnover)"}
knitr::include_graphics(here("figures/fig-2-turnover.png"))
```

```{r species-environment-relationships, fig.pos="H", out.width="14cm", fig.cap="(ref:species-environment-relationships)"}
knitr::include_graphics(here("figures/fig-3-species-environment-relationships.png"))
```

```{r BRT-model-quality, fig.pos="H", out.width="18cm", fig.cap="(ref:BRT-model-quality)"}
knitr::include_graphics(here("figures/fig-4-BRT-model-quality.png"))
```
