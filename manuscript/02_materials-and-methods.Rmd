...
\begin{align}
    \widehat{S_{HDS}}_i = 
        &\ \beta_0 + \\
        &\ \beta_1 \overline{S_{QDS}}_i + 
            \beta_2 \overline{J_{QDS}}_i + 
            \beta_3 SWA_i + \\
        &\ \beta_4 \overline{S_{QDS}}_i SWA_i  + 
            \beta_5 \overline{J_{QDS}}_i SWA_i + 
            \epsilon_i
    (\#eq:gamma-beta-alpha)
\end{align}
