...
Estimated coefficients and significances ($P$-value) following multiple linear regression of HDS species richness against the mean QDS species richness and turnover (Jaccards distance) within a given HDS, of the form in Equation \@ref(eq:S-HDS-formula).
